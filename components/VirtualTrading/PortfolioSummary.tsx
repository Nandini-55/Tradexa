...
export default function PortfolioSummary({ userId }: PortfolioSummaryProps) {
    ...
    const handleTopUp = async () => {
        ...
        try {
            ...
            toast.success("Successfully added 10,000 Virtual Coins to your wallet!");
        ...
        <Card className="glass-card border-none text-foreground h-full relative overflow-hidden group">
            ...
            <CardContent>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-border/50">
                    <div className="space-y-1">
                        <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold">Coins Profit</p>
