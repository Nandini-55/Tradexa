...
export const connectToDatabase = async () => {
    ...
    if (!mongoUri) throw new Error('MONGODB_URI must be set within environment variables');
    ...
    console.log(`Connected to database [${process.env.NODE_ENV || 'development'}] - ${sanitizedUri}`);
